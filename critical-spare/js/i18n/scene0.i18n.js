...
(function () {
  ...
  window.I18N.register({
    en: {
      ...
      'scene0.credits':  'AI in Industry · a manager\'s tour of maintenance decisions under uncertainty',
      'scene0.by':       'BY CARLOS COTRINI',
    },
    jp: {
      'scene0.title':    'クリティカル スペア',
      'scene0.tagline':  'いちばん だいじな きかいが ふるくなってきた。 げんきんは きつい。 うんてん する？ さきに はっちゅう する？ いま こうかん する？',
      'scene0.framing':  'じゅうような しさんは ろうきゅうし、 よびひん よさんは いつも せめぎあい。 よびひんが すくなすぎると こしょうで ラインが なんにちも とまり、 おおすぎると うんてん しほんを たれながす。 きょうは ただしい せんたくが <b>スローガンでは ない</b> ことを みる。 それは じょうきょうで かわる。 まさに しんらいせい マネージャーの ちょっかんだ。',
      'scene0.start':    'スタート',
      'scene0.hook':     'きょうかがくしゅうの ウォークスルー、 1がめんに 1つの アイデア。 やじるしキーか PREV / NEXT ボタンを つかってください。',
      'scene0.credits':  'AI in Industry · ふかくじつせいの もとでの ほぜん いしけってい、 マネージャーむけ ツアー',
      'scene0.by':       'BY CARLOS COTRINI',
    },
  });
})();
